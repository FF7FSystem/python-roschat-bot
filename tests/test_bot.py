...
class TestRosChatBot:
    ...
    def setup_method(self):
        ...
        patcher_env = patch(
            "python_roschat_bot.bot.RosChatBot._resolve_env_file",
            return_value="tests/.env",
        )
        self.addCleanup = getattr(
        ...
        mock_settings_instance.token = (
            "test_token_64_characters_long_for_testing_purposes_only"
        )
        ...
        mock_settings_instance.socket_options = {
            "query": "type-bot",
